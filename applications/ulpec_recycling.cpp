...
//    auto classifier = network.make_logistic_regression<hummus::Regression>(training_database.second, test_database.second, 0.1, 0, 5e-4, 70, 128, 10, 0, hummus::optimiser::Adam, "nmnist_recycling", 0, {});
    auto classifier = network.make_decision<hummus::Decision_Making>(training_database.second, test_database.second, 10, 60, 0, {});
    ...
    network.make_addon<hummus::Connectivity>();
    
    auto& g_maps = network.make_addon<hummus::WeightMaps>("nmnist_recycling_gmaps.bin", 1);
