...
int main(int argc, char** argv)
{
	...
	network.addLayer(layer2, nullptr, 1, 1, 1, decayCurrent+20, decayPotential+20, refractoryPeriod, burstingActivity, eligibilityDecay);
	
	network.convolution(network.getLayers()[layer0], network.getLayers()[layer1], false, 1./25, false, 0);
	network.allToAll(network.getLayers()[layer1], network.getLayers()[layer2], false, 1./8, false, 0);
