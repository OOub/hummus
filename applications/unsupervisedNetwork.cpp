...
//	float decayCurrent2 = 20;
//	float potentialDecay2 = 30;
...
//	network.allToallConnectivity(&network.getNeuronPopulations()[1], &network.getNeuronPopulations()[2], false, 19e-10/3, true, 40); // weight has to be different
