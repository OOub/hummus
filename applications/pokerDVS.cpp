...
int main(int argc, char** argv) {
    ...
    /// creating the layers
    auto pixel_grid = network.makeGrid<hummus::LIF>(32, 32, 1, {}, 900, 200, 10, false, false); // input layer
    auto output = network.makeLayer<hummus::LIF>(4, {&mp}, 900, 200, 10, homeostasis, burst); // output layer
