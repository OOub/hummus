...
int main(int argc, char** argv) {
    ...
    if (cadence) {
        ...
        auto training_database = parser.generate_nmnist_database("/Users/omaroubari/Datasets/mini_es_N-MNIST/Train", 100, {"5", "6"});
        
        // generating N-MNIST test database
        auto test_database = parser.generate_nmnist_database("/Users/omaroubari/Datasets/mini_es_N-MNIST/Test", 100, {"5", "6"});
        ...
        if (logistic_regression) {
            network.make_logistic_regression<hummus::Regression>(training_database.second, 0.1, 0.9, 5e-4, 15, 16, 1, 4, 0, {});
        } else {
