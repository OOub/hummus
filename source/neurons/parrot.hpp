...
namespace hummus {
	...
	public:
        ...
        Parrot(int _neuronID, int _layerID, int _sublayerID, int _rf_id,  std::pair<int, int> _xyCoordinates, int _refractoryPeriod=0, double _traceTimeConstant=20, double _threshold=-50, double _restingPotential=-70) :
