...
namespace hummus {
	...
	public:
		// ----- CONSTRUCTOR -----
		ULPEC_STDP(float _A_pot=0.1, float _A_dep=-0.1, float _thres_pot=-1.2, float _thres_dep=1.2, float G_max=1e-6, float G_min=1e-8) :
                A_pot(_A_pot),
                A_dep(_A_dep),
