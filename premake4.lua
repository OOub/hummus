solution 'icarus'
    ...
    project 'smallNetwork'
        -- General settings
        kind 'ConsoleApp'
        language 'C++'
        location 'build'
        files {'source/**.hpp', 'applications/smallNetwork.cpp'}
	...
	project 'minimumCurrent'
	        -- General settings
	        kind 'ConsoleApp'
	        language 'C++'
	        location 'build'
	        files {'source/**.hpp', 'applications/minimumCurrent.cpp'}
	...
	project 'minimumWeight'
	        -- General settings
	        kind 'ConsoleApp'
	        language 'C++'
	        location 'build'
	        files {'source/**.hpp', 'applications/minimumWeight.cpp'}
