...
def read_td(file_name, orig_at_zero = True, drop_negative_dt = True, verbose = True, events_restriction = [0, np.inf]):
...
def write_td(file_name, ts, coords, pol):
